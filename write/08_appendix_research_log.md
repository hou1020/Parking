...
## A.1 Note on this log

This log records the supervision meetings, tasks, problems and outputs of the dissertation project between April and August 2026. It is compiled from two sources: the record of supervision meetings held with CASA and Centre for Cities (Section A.2), and the commit history of the project repository, archived at **https://github.com/hou1020/Parking** (Section A.3).
